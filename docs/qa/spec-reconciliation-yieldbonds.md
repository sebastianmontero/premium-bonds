...
- **On-Chain Reality:** In [`PrizeTier`](file:///home/sebastian/vsc-workspace/premium-bonds/anchor/programs/anchor/src/state/pool.rs#L31-L38), `basis_points` represents the basis points *per winner*.
