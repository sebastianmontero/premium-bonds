...
/// format.
#[cfg_attr(not(target_os = "solana"), frozen_abi(digest = "G4EAiqmGgBprgf5ePYemLJcoFfx4R7rhC1Weo2FVJ7fn"))]
#[derive(Debug, PartialEq, Eq, Clone)]
#[cfg_attr(not(target_os = "solana"), derive(AbiEnumVisitor, AbiExample))]
