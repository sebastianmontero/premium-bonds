...
- Show a brief gray/neutral toast (duration: 2000ms): _"Transaction cancelled by user."_ or simply clear the loading state.
...
toast.error("Insufficient SOL for Gas", {
  description:
    "You need ~0.005 SOL to pay for account creation and network fees.",
  action: {
    label: "Get SOL",
