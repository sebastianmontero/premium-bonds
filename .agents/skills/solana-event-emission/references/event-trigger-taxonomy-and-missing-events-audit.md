...
1. **Off-Chain Indexer Blindness**: Yellowstone Geyser, Helius Webhooks, and custom indexers cannot distinguish _what_ business action occurred without reverse-engineering raw byte diffs.
...
- `post_vault_balance`: Vault balance _after_ the mutation (enables self-healing indexers).
