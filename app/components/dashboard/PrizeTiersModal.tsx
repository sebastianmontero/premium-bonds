...
export function PrizeTiersModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className="relative w-full max-w-3xl rounded-2xl border border-surface-container-high/60 bg-[#0F111A]/95 p-4 sm:p-5 shadow-2xl z-10 overflow-hidden flex flex-col max-h-[88vh] space-y-4 animate-scale-in"
        role="dialog"
        aria-modal="true"
