...
echo -n "devnet" | npx vercel env add NEXT_PUBLIC_NETWORK preview || true
echo -n "https://api.devnet.solana.com" | npx vercel env add NEXT_PUBLIC_RPC_URL preview || true
...
echo -n "mainnet-beta" | npx vercel env add NEXT_PUBLIC_NETWORK production || true
...
echo -n "https://mainnet.helius-rpc.com/?api-key=${HELIUS_KEY}" | npx vercel env add NEXT_PUBLIC_RPC_URL production || true

echo "Setting up Development Environment (Devnet)..."
echo -n "devnet" | npx vercel env add NEXT_PUBLIC_NETWORK development || true
echo -n "https://api.devnet.solana.com" | npx vercel env add NEXT_PUBLIC_RPC_URL development || true
